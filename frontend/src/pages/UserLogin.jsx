    ...
    <div className="p-7 h-screen flex flex-col justify-between ">
      ...
      />
        <form onSubmit={(e)=>{
          ...
          <p className="text-center">New Here?<Link to="/signup" className="text-[#171a79]">Create New Account</Link></p>
        </form>
      </div>
      <div>
        <Link to="/captain-login"
        className="bg-[#10b461] flex flex-col justify-center items-center text-white font-semibold rounded mb-5 px-4 py-2  w-full text-lg placeholder:text-base">Sign In As captain</Link>
      </div>
    </div>
  );
};
