  ...
  return (
    ...
    />
      <form onSubmit={(e)=>{
        ...
        <p className="text-center">Join a fleet?<Link to="/captain-signup" className="text-[#171a79]">Register as a captain</Link></p>
      </form>
    </div>
    <div>
      <Link to="/login"
      className="bg-[#d5622d] flex flex-col justify-center items-center text-white font-semibold rounded mb-5 px-4 py-2  w-full text-lg placeholder:text-base">Sign In As User</Link>
    </div>
  </div>
  )
}
